        ...
        <div class="flex flex-col items-center gap-6">
            <div class="flex gap-3 pb-[22px]">
                <NuxtLink to="#" class="flex justify-center items-center xl:h-8 xl:w-8 w-12 h-12 rounded-[12px] bg-[rgba(128,128,128,.2)]">
                    <Icon name="mdi:vk-circle" class="text-white xl:text-xl text-2xl"/>
                </NuxtLink>
                <NuxtLink to="https://discord.gg/ZE978BWy" class="flex justify-center items-center xl:h-8 xl:w-8 w-12 h-12 rounded-[12px] bg-[rgba(128,128,128,.2)]">
                    <Icon name="mdi:discord" class="text-white xl:text-xl text-2xl"/>
                </NuxtLink>
                <NuxtLink to="https://www.youtube.com/channel/UCGuwLedm72s1CoM-6a5XDiA" class="flex justify-center items-center xl:h-8 xl:w-8 w-12 h-12 rounded-[12px] bg-[rgba(128,128,128,.2)]">
                    <Icon name="mdi:youtube" class="text-white xl:text-xl text-2xl"/>
                </NuxtLink>
            </div>
            <div class="flex max-md:flex-col items-center gap-4">
                <NuxtLink to="#">
                    <svg width="99" height="32" class="fill-[#7E7E7E]" viewBox="0 0 587.93 165">
                        <title> Riot Games </title><title>riotLogo-mobile21</title>
                ...
                <NuxtLink to="#">
                    <Icon name="tabler:brand-valorant" class="text-white text-5xl"></Icon>
                </NuxtLink>
            </div>
            <p class="text-[13px] text-[#7E7E7E] md:w-1/2 text-center font-medium">© 2023 Riot Games, Inc. Riot Games, VALORANT и все связанные с ними логотипы являются торговыми знаками или зарегистрированными торговыми знаками, принадлежащими Riot Games, Inc.</p>
            <div class="flex max-lg:flex-col items-center gap-3">
                <NuxtLink to="#" class="uppercase text-[13px] text-white font-bold px-4 py-2 hover:rounded-md hover:bg-[rgba(128,128,128,.3)] transition-all duration-500">политика конфиденциальности</NuxtLink>
                <NuxtLink to="#" class="uppercase text-[13px] text-white font-bold px-4 py-2 hover:rounded-md hover:bg-[rgba(128,128,128,.3)] transition-all duration-500">условия использования</NuxtLink>
                <NuxtLink to="#" class="uppercase text-[13px] text-white font-bold px-4 py-2 hover:rounded-md hover:bg-[rgba(128,128,128,.3)] transition-all duration-500">настройки cookie</NuxtLink>
            </div>
            <NuxtLink to="#" class="p-3 rounded-lg bg-[#292929]">
                <img src="/images/footer/16.png" alt="">
            </NuxtLink>
        </div>
    </footer> -->
    ...
    <footer class="grid-container pt-16 md:pt-20 xl:pt-40">
        <div class="flex flex-col items-center gap-8 md:gap-12 xl:gap-[56px]">
            ...
            <div class="flex items-center gap-9 xl:gap-16">
                <NuxtLink to="/" class="group relative hover:scale-125 hover:outline-[#2EECC5]/10 transition-all duration-500 rounded-full flex items-center justify-center w-10 h-10 md:w-12 md:h-12 xl:w-20 xl:h-20 bg-white outline outline-1 outline-white/10 outline-offset-[10px]">
                    <Icon name="ic:baseline-telegram" class="text-2xl md:text-3xl xl:text-4xl text-black z-[2]"/>
                    <span class="absolute w-full h-full z-[1] radial top-0 left-0 opacity-0 group-hover:opacity-100 rounded-full transition-all duration-500"></span>
                </NuxtLink>
                <NuxtLink to="/" class="group relative hover:scale-125 hover:outline-[#2EECC5]/10 transition-all duration-500 rounded-full flex items-center justify-center w-10 h-10 md:w-12 md:h-12 xl:w-20 xl:h-20 bg-white outline outline-1 outline-white/10 outline-offset-[10px]">
                    <Icon name="ic:baseline-discord" class="text-2xl md:text-3xl xl:text-4xl text-black z-[2]"/>
                    <span class="absolute w-full h-full z-[1] radial top-0 left-0 opacity-0 group-hover:opacity-100 rounded-full transition-all duration-500"></span>
                </NuxtLink>
                <NuxtLink to="/" class="group relative hover:scale-125  hover:outline-[#2EECC5]/10 transition-all duration-500 rounded-full flex items-center justify-center w-10 h-10 md:w-12 md:h-12 xl:w-20 xl:h-20 bg-white outline outline-1 outline-white/10 outline-offset-[10px]">
                    <Icon name="mdi:twitch" class="text-2xl md:text-3xl xl:text-4xl text-black z-[2]"/>
                    <span class="absolute w-full h-full z-[1] radial top-0 left-0 opacity-0 group-hover:opacity-100 rounded-full transition-all duration-500"></span>
                </NuxtLink>
            </div>
            <div class="flex items-center gap-9 mt-4">
                <NuxtLink to="/">                    
                    <img src="/images/footer/valorant.png" alt="" class="w-[35px] xl:w-[50px]">
                </NuxtLink>
                <NuxtLink to="/">                    
                    <img src="/images/footer/riot.png" alt="" class="w-[70px] xl:w-[100px]">
                </NuxtLink>
            </div>
            <p class="max-w-[620px] text-center font-normal text-base text-white/50">
