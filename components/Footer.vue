<template>
    <footer class="grid-container bg-[#111111] mt-auto py-[18px] pb-12 Neue">
        <div class="flex flex-col items-center">
            <div class="flex gap-3 pb-[18px]">
                <NuxtLink to="#" class="flex justify-center items-center lg:h-8 lg:w-8 w-12 h-12 rounded-[12px] bg-[rgba(128,128,128,.2)]">
                    <Icon name="mdi:vk-circle" class="text-white lg:text-xl text-2xl"/>
                </NuxtLink>
                <NuxtLink to="#" class="flex justify-center items-center lg:h-8 lg:w-8 w-12 h-12 rounded-[12px] bg-[rgba(128,128,128,.2)]">
                    <Icon name="mdi:discord" class="text-white lg:text-xl text-2xl"/>
                </NuxtLink>
                <NuxtLink to="#" class="flex justify-center items-center lg:h-8 lg:w-8 w-12 h-12 rounded-[12px] bg-[rgba(128,128,128,.2)]">
                    <Icon name="ri:twitter-x-fill" class="text-white lg:text-xl text-2xl"/>
                </NuxtLink>
                <NuxtLink to="#" class="flex justify-center items-center lg:h-8 lg:w-8 w-12 h-12 rounded-[12px] bg-[rgba(128,128,128,.2)]">
                    <Icon name="mdi:youtube" class="text-white lg:text-xl text-2xl"/>
                </NuxtLink>
            </div>
            <div class="flex max-md:flex-col items-center gap-4 py-7">
                <nuxt-link to="#">
            ...
            <div class="flex max-lg:flex-col items-center gap-3 py-6">
                <nuxt-link to="#" class="uppercase text-[13px] text-white font-bold px-4 py-2 hover:rounded-md hover:bg-[rgba(128,128,128,.3)] transition-all duration-500">политика конфиденциальности</nuxt-link>
                <nuxt-link to="#" class="uppercase text-[13px] text-white font-bold px-4 py-2 hover:rounded-md hover:bg-[rgba(128,128,128,.3)] transition-all duration-500">условия использования</nuxt-link>
                <nuxt-link to="#" class="uppercase text-[13px] text-white font-bold px-4 py-2 hover:rounded-md hover:bg-[rgba(128,128,128,.3)] transition-all duration-500">настройки cookie</nuxt-link>
            </div>
            <nuxt-link to="#" class="p-3 rounded-lg bg-[#292929]">
